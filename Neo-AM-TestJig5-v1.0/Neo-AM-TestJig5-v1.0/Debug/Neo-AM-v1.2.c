...
void rcv_proc1(void){
 ...
 switch(rcv_command1){
        ...
        case 0x83:  INValve_OpFlag=true;    Cmd_Dat=rcv_buf1[4]; break;
        case 0x84:  OUTValve_OpFlag=true;   Cmd_Dat=rcv_buf1[4]; break;
        case 0x85:  INValve_ClFlag=true;    Cmd_Dat=rcv_buf1[4]; break;
        case 0x86:  OUTValve_ClFlag=true;   Cmd_Dat=rcv_buf1[4]; break;
        case 0x87:  Calib_CmdFlag=true;     Cmd_Dat=rcv_buf1[4]; break;
        case 0x88:  Motor_CmdFlag=true;     Cmd_Dat=rcv_buf1[4]; break;

        case 0x81:
            Pressure_Data_Send1();  break;
        case 0x82:
            Calib_CmdFlag=true; break;
